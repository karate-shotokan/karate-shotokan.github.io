...
const benefits = [
  {
    icon: Shield,
    title: "Disciplina",
    description: "Desenvolva autocontrolo e respeito através da prática tradicional.",
  },
  {
    icon: Users,
    title: "Comunidade",
    description: "Faça parte de uma família unida pela paixão pelas artes marciais.",
  },
  {
    icon: Trophy,
    title: "Excelência",
    description: "Alcance o seu potencial máximo com ensino de qualidade superior.",
  },
  {
    icon: Heart,
    title: "Bem-Estar",
    description: "Melhore a sua saúde física e mental de forma equilibrada.",
  },
  {
    icon: Target,
    title: "Foco",
    description: "Aprenda a concentrar-se e a superar desafios do dia-a-dia.",
  },
  {
    icon: Zap,
    title: "Energia",
    description: "Ganhe força, flexibilidade e condição física de forma progressiva.",
  },
];
...
const testimonials = [
  {
    name: "Ana Silva",
    role: "Mãe de praticante",
    text: "O meu filho transformou-se completamente. Mais disciplinado, focado e respeitador. O Sensei Carlos é um verdadeiro exemplo.",
    rating: 5,
  },
  {
    name: "João Martins",
    role: "Praticante Adulto",
    text: "Treinar aqui mudou a minha vida. Não é apenas karaté, é uma filosofia de vida que se aplica a tudo.",
    rating: 5,
  },
  {
    name: "Maria Costa",
    role: "Cinturão Castanho",
    text: "A exigência é alta, mas o apoio também. Sinto que evoluí não só como karateka, mas como pessoa.",
    rating: 5,
  },
];
    ...
    <div className="pt-20">
      ...
      <section className="relative h-[600px] md:h-[700px] flex items-center justify-center bg-neutral-900">
        <div className="absolute inset-0 overflow-hidden">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1608583224016-d7fdbc3bf282?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYXJ0aWFsJTIwYXJ0cyUyMHNlbnNlaSUyMGluc3RydWN0b3J8ZW58MXx8fHwxNzc0OTcyNTg0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 max-w-4xl mx-auto">
            Karaté Shotokan<br />em Portugal
          </h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-neutral-300">
            Aprenda a verdadeira arte marcial com o Sensei Carlos Cardoso
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-neutral-900 text-lg h-14 px-8">
              <Link to="/dojos">Encontrar Dojo</Link>
            </Button>
          </div>
        </div>
      </section>
              ...
              <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  <div className="w-12 h-12 bg-[#8B0000]/10 rounded-lg flex items-center justify-center mb-4">
                    <benefit.icon className="text-[#8B0000]" size={24} />
                  </div>
